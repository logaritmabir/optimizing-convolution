...
int main(int argc, char** argv)
{
    ...
    // std::string img_path1024 = "/home/ben/Desktop/optimizing-convolution/optimizing-convolution/images/1024.png";
    // std::string img_path2048 = "C:/Users/ben/Desktop/optimizing-convolution/images/2048.png";
    std::string img_path4096 = "/home/ben/Desktop/optimizing-convolution/optimizing-convolution/images/4096.png";
...
/* This part has been removed from the project for a long time ago.*/

/* If anyone has a intent to make the images represented by float numbers the code at the below could be used.
   In that case, kernels should be redesigned for double precision datas.*/
